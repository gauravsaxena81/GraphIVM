...
namespace dbtoaster {
  ...
  struct COUNT_entry {
    long A_FOLLOWER_ID; long Z_TWEET_ID; long __av;  COUNT_entry* nxt; COUNT_entry* prv;
    explicit COUNT_entry() : nxt(nullptr), prv(nullptr) { /*A_FOLLOWER_ID = 0L; Z_TWEET_ID = 0L; __av = 0L; */ }
    explicit COUNT_entry(const long c0, const long c1, const long c2) { A_FOLLOWER_ID = c0; Z_TWEET_ID = c1; __av = c2; }
    COUNT_entry(const COUNT_entry& other) : A_FOLLOWER_ID( other.A_FOLLOWER_ID ), Z_TWEET_ID( other.Z_TWEET_ID ), __av( other.__av ), nxt( nullptr ), prv( nullptr ) {}
    FORCE_INLINE COUNT_entry& modify(const long c0, const long c1) { A_FOLLOWER_ID = c0; Z_TWEET_ID = c1;  return *this; }
  ...
  struct COUNT_mapkey01_idxfn {
    ...
    FORCE_INLINE static bool equals(const COUNT_entry& x, const COUNT_entry& y) {
      return x.A_FOLLOWER_ID == y.A_FOLLOWER_ID && x.Z_TWEET_ID == y.Z_TWEET_ID;
    }
  };
  ...
  struct COUNT_mTWEET1_entry {
    long A_FOLLOWER_ID; long COUNT_mTWEETTWEET_USER_ID; long __av;  COUNT_mTWEET1_entry* nxt; COUNT_mTWEET1_entry* prv;
    explicit COUNT_mTWEET1_entry() : nxt(nullptr), prv(nullptr) { /*A_FOLLOWER_ID = 0L; COUNT_mTWEETTWEET_USER_ID = 0L; __av = 0L; */ }
    explicit COUNT_mTWEET1_entry(const long c0, const long c1, const long c2) { A_FOLLOWER_ID = c0; COUNT_mTWEETTWEET_USER_ID = c1; __av = c2; }
    COUNT_mTWEET1_entry(const COUNT_mTWEET1_entry& other) : A_FOLLOWER_ID( other.A_FOLLOWER_ID ), COUNT_mTWEETTWEET_USER_ID( other.COUNT_mTWEETTWEET_USER_ID ), __av( other.__av ), nxt( nullptr ), prv( nullptr ) {}
    FORCE_INLINE COUNT_mTWEET1_entry& modify(const long c0, const long c1) { A_FOLLOWER_ID = c0; COUNT_mTWEETTWEET_USER_ID = c1;  return *this; }
  ...
  struct COUNT_mTWEET1_mapkey01_idxfn {
    ...
    FORCE_INLINE static bool equals(const COUNT_mTWEET1_entry& x, const COUNT_mTWEET1_entry& y) {
      return x.A_FOLLOWER_ID == y.A_FOLLOWER_ID && x.COUNT_mTWEETTWEET_USER_ID == y.COUNT_mTWEETTWEET_USER_ID;
    }
  };
  ...
  struct COUNT_mFOLLOWER2_entry {
    long COUNT_mFOLLOWERFOLLOWER_USER_ID; long Z_TWEET_ID; long __av;  COUNT_mFOLLOWER2_entry* nxt; COUNT_mFOLLOWER2_entry* prv;
    explicit COUNT_mFOLLOWER2_entry() : nxt(nullptr), prv(nullptr) { /*COUNT_mFOLLOWERFOLLOWER_USER_ID = 0L; Z_TWEET_ID = 0L; __av = 0L; */ }
    explicit COUNT_mFOLLOWER2_entry(const long c0, const long c1, const long c2) { COUNT_mFOLLOWERFOLLOWER_USER_ID = c0; Z_TWEET_ID = c1; __av = c2; }
    COUNT_mFOLLOWER2_entry(const COUNT_mFOLLOWER2_entry& other) : COUNT_mFOLLOWERFOLLOWER_USER_ID( other.COUNT_mFOLLOWERFOLLOWER_USER_ID ), Z_TWEET_ID( other.Z_TWEET_ID ), __av( other.__av ), nxt( nullptr ), prv( nullptr ) {}
    FORCE_INLINE COUNT_mFOLLOWER2_entry& modify(const long c0, const long c1) { COUNT_mFOLLOWERFOLLOWER_USER_ID = c0; Z_TWEET_ID = c1;  return *this; }
    FORCE_INLINE COUNT_mFOLLOWER2_entry& modify0(const long c0) { COUNT_mFOLLOWERFOLLOWER_USER_ID = c0;  return *this; }
    template<class Archive>
    void serialize(Archive& ar, const unsigned int version) const 
    {
      ar << ELEM_SEPARATOR;
  ...
  struct COUNT_mFOLLOWER2_mapkey01_idxfn {
    ...
    FORCE_INLINE static bool equals(const COUNT_mFOLLOWER2_entry& x, const COUNT_mFOLLOWER2_entry& y) {
      return x.COUNT_mFOLLOWERFOLLOWER_USER_ID == y.COUNT_mFOLLOWERFOLLOWER_USER_ID && x.Z_TWEET_ID == y.Z_TWEET_ID;
    }
  };
  ...
  struct COUNT_mFOLLOWER4_entry {
    long COUNT_mFOLLOWERFOLLOWER_FOLLOWER_ID; long A_FOLLOWER_ID; long __av;  COUNT_mFOLLOWER4_entry* nxt; COUNT_mFOLLOWER4_entry* prv;
    explicit COUNT_mFOLLOWER4_entry() : nxt(nullptr), prv(nullptr) { /*COUNT_mFOLLOWERFOLLOWER_FOLLOWER_ID = 0L; A_FOLLOWER_ID = 0L; __av = 0L; */ }
    explicit COUNT_mFOLLOWER4_entry(const long c0, const long c1, const long c2) { COUNT_mFOLLOWERFOLLOWER_FOLLOWER_ID = c0; A_FOLLOWER_ID = c1; __av = c2; }
    COUNT_mFOLLOWER4_entry(const COUNT_mFOLLOWER4_entry& other) : COUNT_mFOLLOWERFOLLOWER_FOLLOWER_ID( other.COUNT_mFOLLOWERFOLLOWER_FOLLOWER_ID ), A_FOLLOWER_ID( other.A_FOLLOWER_ID ), __av( other.__av ), nxt( nullptr ), prv( nullptr ) {}
    FORCE_INLINE COUNT_mFOLLOWER4_entry& modify(const long c0, const long c1) { COUNT_mFOLLOWERFOLLOWER_FOLLOWER_ID = c0; A_FOLLOWER_ID = c1;  return *this; }
    FORCE_INLINE COUNT_mFOLLOWER4_entry& modify0(const long c0) { COUNT_mFOLLOWERFOLLOWER_FOLLOWER_ID = c0;  return *this; }
    FORCE_INLINE COUNT_mFOLLOWER4_entry& modify1(const long c1) { A_FOLLOWER_ID = c1;  return *this; }
    template<class Archive>
    void serialize(Archive& ar, const unsigned int version) const 
    {
      ar << ELEM_SEPARATOR;
  ...
  struct COUNT_mFOLLOWER4_mapkey01_idxfn {
    ...
    FORCE_INLINE static bool equals(const COUNT_mFOLLOWER4_entry& x, const COUNT_mFOLLOWER4_entry& y) {
      return x.COUNT_mFOLLOWERFOLLOWER_FOLLOWER_ID == y.COUNT_mFOLLOWERFOLLOWER_FOLLOWER_ID && x.A_FOLLOWER_ID == y.A_FOLLOWER_ID;
    }
  };
  ...
  struct COUNT_mFOLLOWER5_entry {
    long COUNT_mFOLLOWERFOLLOWER_USER_ID; long Z_TWEET_ID; long __av;  COUNT_mFOLLOWER5_entry* nxt; COUNT_mFOLLOWER5_entry* prv;
    explicit COUNT_mFOLLOWER5_entry() : nxt(nullptr), prv(nullptr) { /*COUNT_mFOLLOWERFOLLOWER_USER_ID = 0L; Z_TWEET_ID = 0L; __av = 0L; */ }
    explicit COUNT_mFOLLOWER5_entry(const long c0, const long c1, const long c2) { COUNT_mFOLLOWERFOLLOWER_USER_ID = c0; Z_TWEET_ID = c1; __av = c2; }
    COUNT_mFOLLOWER5_entry(const COUNT_mFOLLOWER5_entry& other) : COUNT_mFOLLOWERFOLLOWER_USER_ID( other.COUNT_mFOLLOWERFOLLOWER_USER_ID ), Z_TWEET_ID( other.Z_TWEET_ID ), __av( other.__av ), nxt( nullptr ), prv( nullptr ) {}
    FORCE_INLINE COUNT_mFOLLOWER5_entry& modify(const long c0, const long c1) { COUNT_mFOLLOWERFOLLOWER_USER_ID = c0; Z_TWEET_ID = c1;  return *this; }
    FORCE_INLINE COUNT_mFOLLOWER5_entry& modify0(const long c0) { COUNT_mFOLLOWERFOLLOWER_USER_ID = c0;  return *this; }
    template<class Archive>
    void serialize(Archive& ar, const unsigned int version) const 
    {
      ar << ELEM_SEPARATOR;
  ...
  struct data_t : tlq_t{
    ...
    void on_insert_FOLLOWER(const long follower_user_id, const long follower_follower_id) {
      ...
      {  //++tN;
        _c1.clear();
        { //slice
          const HASH_RES_t h1 = COUNT_mFOLLOWER2_mapkey0_idxfn::hash(se2.modify0(follower_user_id));
        ...
        { //slice
          const HASH_RES_t h2 = COUNT_mFOLLOWER5_mapkey0_idxfn::hash(se3.modify0(follower_user_id));
        ...
        { //temp foreach
          ...
          while(e3){
            ...
            long v4 = e3->__av;
            COUNT.addOrDelOnZero(se1.modify(follower_follower_id,z_tweet_id),v4);
            e3 = e3->nxt;
          }
        }
        { //slice
          const HASH_RES_t h4 = COUNT_mFOLLOWER4_mapkey0_idxfn::hash(se5.modify0(follower_follower_id));
          const HashIndex_COUNT_mFOLLOWER4_map_0* i3 = static_cast<HashIndex_COUNT_mFOLLOWER4_map_0*>(COUNT_mFOLLOWER4.index[1]);
          HashIndex_COUNT_mFOLLOWER4_map_0::IdxNode* n3 = &(i3->buckets_[h4 % i3->size_]);
          COUNT_mFOLLOWER4_entry* e4;
          do if ((e4=n3->obj) && h4 == n3->hash && COUNT_mFOLLOWER4_mapkey0_idxfn::equals(se5, *e4)) {
            long a_follower_id = e4->A_FOLLOWER_ID;
            long v5 = e4->__av;
            { //slice
              const HASH_RES_t h3 = COUNT_mFOLLOWER5_mapkey0_idxfn::hash(se4.modify0(follower_user_id));
              ...
              do if ((e5=n4->obj) && h3 == n4->hash && COUNT_mFOLLOWER5_mapkey0_idxfn::equals(se4, *e5)) {
                ...
                long v6 = e5->__av;
                COUNT.addOrDelOnZero(se1.modify(a_follower_id,z_tweet_id),(v5 * v6));
              } while ((n4=n4->nxt));
            }
          } while ((n3=n3->nxt));
        }
        _c2.clear();
        { //slice
          const HASH_RES_t h5 = COUNT_mFOLLOWER4_mapkey1_idxfn::hash(se7.modify1(follower_user_id));
          const HashIndex_COUNT_mFOLLOWER4_map_1* i5 = static_cast<HashIndex_COUNT_mFOLLOWER4_map_1*>(COUNT_mFOLLOWER4.index[2]);
          HashIndex_COUNT_mFOLLOWER4_map_1::IdxNode* n5 = &(i5->buckets_[h5 % i5->size_]);
          COUNT_mFOLLOWER4_entry* e6;
          do if ((e6=n5->obj) && h5 == n5->hash && COUNT_mFOLLOWER4_mapkey1_idxfn::equals(se7, *e6)) {
            long count_mtweettweet_user_id = e6->COUNT_mFOLLOWERFOLLOWER_FOLLOWER_ID;
            long v8 = e6->__av;
            add_to_temp_map(_c2, st3.modify(count_mtweettweet_user_id,v8));
          } while ((n5=n5->nxt));
        }
        (/*if */(follower_user_id == follower_follower_id) ? add_to_temp_map(_c2, st4.modify(follower_user_id,1L)) : voidFunc());
        { //temp foreach
          tuple2_L_L* e7 = _c2.head;
          while(e7){
            long count_mtweettweet_user_id = e7->_1;
            long v9 = e7->__av;
            COUNT_mTWEET1.addOrDelOnZero(se6.modify(follower_follower_id,count_mtweettweet_user_id),v9);
            e7 = e7->nxt;
          }
        }
        { //slice
          const HASH_RES_t h6 = COUNT_mFOLLOWER4_mapkey0_idxfn::hash(se8.modify0(follower_follower_id));
          const HashIndex_COUNT_mFOLLOWER4_map_0* i6 = static_cast<HashIndex_COUNT_mFOLLOWER4_map_0*>(COUNT_mFOLLOWER4.index[1]);
          HashIndex_COUNT_mFOLLOWER4_map_0::IdxNode* n6 = &(i6->buckets_[h6 % i6->size_]);
          COUNT_mFOLLOWER4_entry* e8;
          do if ((e8=n6->obj) && h6 == n6->hash && COUNT_mFOLLOWER4_mapkey0_idxfn::equals(se8, *e8)) {
            long a_follower_id = e8->A_FOLLOWER_ID;
            long v10 = e8->__av;
            COUNT_mTWEET1.addOrDelOnZero(se6.modify(a_follower_id,follower_user_id),v10);
          } while ((n6=n6->nxt));
        }
        { //slice
          const HASH_RES_t h7 = COUNT_mFOLLOWER5_mapkey0_idxfn::hash(se10.modify0(follower_user_id));
          ...
          do if ((e9=n7->obj) && h7 == n7->hash && COUNT_mFOLLOWER5_mapkey0_idxfn::equals(se10, *e9)) {
            ...
            long v11 = e9->__av;
            COUNT_mFOLLOWER2.addOrDelOnZero(se9.modify(follower_follower_id,z_tweet_id),v11);
          } while ((n7=n7->nxt));
        }
    ...
    void on_delete_FOLLOWER(const long follower_user_id, const long follower_follower_id) {
      ...
      {  //++tN;
        _c3.clear();
        { //slice
          const HASH_RES_t h8 = COUNT_mFOLLOWER2_mapkey0_idxfn::hash(se13.modify0(follower_user_id));
        ...
        { //slice
          const HASH_RES_t h9 = COUNT_mFOLLOWER5_mapkey0_idxfn::hash(se14.modify0(follower_user_id));
          ...
          do if ((e11=n9->obj) && h9 == n9->hash && COUNT_mFOLLOWER5_mapkey0_idxfn::equals(se14, *e11)) {
            ...
            long v14 = e11->__av;
            (/*if */(follower_user_id == follower_follower_id) ? add_to_temp_map(_c3, st6.modify(z_tweet_id,v14)) : voidFunc());
          } while ((n9=n9->nxt));
        }
        { //temp foreach
          ...
          while(e12){
            ...
            long v15 = e12->__av;
            COUNT.addOrDelOnZero(se12.modify(follower_follower_id,z_tweet_id),v15);
            e12 = e12->nxt;
          }
        }
        { //slice
          const HASH_RES_t h11 = COUNT_mFOLLOWER4_mapkey0_idxfn::hash(se16.modify0(follower_follower_id));
          const HashIndex_COUNT_mFOLLOWER4_map_0* i10 = static_cast<HashIndex_COUNT_mFOLLOWER4_map_0*>(COUNT_mFOLLOWER4.index[1]);
          HashIndex_COUNT_mFOLLOWER4_map_0::IdxNode* n10 = &(i10->buckets_[h11 % i10->size_]);
          COUNT_mFOLLOWER4_entry* e13;
          do if ((e13=n10->obj) && h11 == n10->hash && COUNT_mFOLLOWER4_mapkey0_idxfn::equals(se16, *e13)) {
            long a_follower_id = e13->A_FOLLOWER_ID;
            long v16 = e13->__av;
            { //slice
              const HASH_RES_t h10 = COUNT_mFOLLOWER5_mapkey0_idxfn::hash(se15.modify0(follower_user_id));
              ...
              do if ((e14=n11->obj) && h10 == n11->hash && COUNT_mFOLLOWER5_mapkey0_idxfn::equals(se15, *e14)) {
                ...
                long v17 = e14->__av;
                COUNT.addOrDelOnZero(se12.modify(a_follower_id,z_tweet_id),(v16 * (v17 * -1L)));
              } while ((n11=n11->nxt));
            }
          } while ((n10=n10->nxt));
        }
        _c4.clear();
        { //slice
          const HASH_RES_t h12 = COUNT_mFOLLOWER4_mapkey1_idxfn::hash(se18.modify1(follower_user_id));
          const HashIndex_COUNT_mFOLLOWER4_map_1* i12 = static_cast<HashIndex_COUNT_mFOLLOWER4_map_1*>(COUNT_mFOLLOWER4.index[2]);
          HashIndex_COUNT_mFOLLOWER4_map_1::IdxNode* n12 = &(i12->buckets_[h12 % i12->size_]);
          COUNT_mFOLLOWER4_entry* e15;
          do if ((e15=n12->obj) && h12 == n12->hash && COUNT_mFOLLOWER4_mapkey1_idxfn::equals(se18, *e15)) {
            long count_mtweettweet_user_id = e15->COUNT_mFOLLOWERFOLLOWER_FOLLOWER_ID;
            long v19 = e15->__av;
            add_to_temp_map(_c4, st7.modify(count_mtweettweet_user_id,(v19 * -1L)));
          } while ((n12=n12->nxt));
        }
        (/*if */(follower_user_id == follower_follower_id) ? add_to_temp_map(_c4, st8.modify(follower_user_id,1L)) : voidFunc());
        { //temp foreach
          tuple2_L_L* e16 = _c4.head;
          while(e16){
            long count_mtweettweet_user_id = e16->_1;
            long v20 = e16->__av;
            COUNT_mTWEET1.addOrDelOnZero(se17.modify(follower_follower_id,count_mtweettweet_user_id),v20);
            e16 = e16->nxt;
          }
        }
        { //slice
          const HASH_RES_t h13 = COUNT_mFOLLOWER4_mapkey0_idxfn::hash(se19.modify0(follower_follower_id));
          const HashIndex_COUNT_mFOLLOWER4_map_0* i13 = static_cast<HashIndex_COUNT_mFOLLOWER4_map_0*>(COUNT_mFOLLOWER4.index[1]);
          HashIndex_COUNT_mFOLLOWER4_map_0::IdxNode* n13 = &(i13->buckets_[h13 % i13->size_]);
          COUNT_mFOLLOWER4_entry* e17;
          do if ((e17=n13->obj) && h13 == n13->hash && COUNT_mFOLLOWER4_mapkey0_idxfn::equals(se19, *e17)) {
            long a_follower_id = e17->A_FOLLOWER_ID;
            long v21 = e17->__av;
            COUNT_mTWEET1.addOrDelOnZero(se17.modify(a_follower_id,follower_user_id),(v21 * -1L));
          } while ((n13=n13->nxt));
        }
        { //slice
          const HASH_RES_t h14 = COUNT_mFOLLOWER5_mapkey0_idxfn::hash(se21.modify0(follower_user_id));
          ...
          do if ((e18=n14->obj) && h14 == n14->hash && COUNT_mFOLLOWER5_mapkey0_idxfn::equals(se21, *e18)) {
            ...
            long v22 = e18->__av;
            COUNT_mFOLLOWER2.addOrDelOnZero(se20.modify(follower_follower_id,z_tweet_id),(v22 * -1L));
          } while ((n14=n14->nxt));
        }
      ...
      {  //++tN;
        { //slice
          ...
          do if ((e19=n15->obj) && h15 == n15->hash && COUNT_mTWEET1_mapkey1_idxfn::equals(se24, *e19)) {
            long a_follower_id = e19->A_FOLLOWER_ID;
            long v23 = e19->__av;
		api.useDiff(a_follower_id, a_follower_id, tweet_tweet_id);
            //COUNT.addOrDelOnZero(se23.modify(a_follower_id,tweet_tweet_id),v23);
          } while ((n15=n15->nxt));
        }
        { //slice
          const HASH_RES_t h16 = COUNT_mFOLLOWER4_mapkey0_idxfn::hash(se26.modify0(tweet_user_id));
          const HashIndex_COUNT_mFOLLOWER4_map_0* i16 = static_cast<HashIndex_COUNT_mFOLLOWER4_map_0*>(COUNT_mFOLLOWER4.index[1]);
          HashIndex_COUNT_mFOLLOWER4_map_0::IdxNode* n16 = &(i16->buckets_[h16 % i16->size_]);
          COUNT_mFOLLOWER4_entry* e20;
          do if ((e20=n16->obj) && h16 == n16->hash && COUNT_mFOLLOWER4_mapkey0_idxfn::equals(se26, *e20)) {
            long count_mfollowerfollower_user_id = e20->A_FOLLOWER_ID;
            long v24 = e20->__av;
            COUNT_mFOLLOWER2.addOrDelOnZero(se25.modify(count_mfollowerfollower_user_id,tweet_tweet_id),v24);
          } while ((n16=n16->nxt));
        }
      ...
      {  //++tN;
        { //slice
          ...
          do if ((e21=n17->obj) && h17 == n17->hash && COUNT_mTWEET1_mapkey1_idxfn::equals(se29, *e21)) {
            long a_follower_id = e21->A_FOLLOWER_ID;
            long v25 = e21->__av;
            COUNT.addOrDelOnZero(se28.modify(a_follower_id,tweet_tweet_id),(v25 * -1L));
          } while ((n17=n17->nxt));
        }
        { //slice
          const HASH_RES_t h18 = COUNT_mFOLLOWER4_mapkey0_idxfn::hash(se31.modify0(tweet_user_id));
          const HashIndex_COUNT_mFOLLOWER4_map_0* i18 = static_cast<HashIndex_COUNT_mFOLLOWER4_map_0*>(COUNT_mFOLLOWER4.index[1]);
          HashIndex_COUNT_mFOLLOWER4_map_0::IdxNode* n18 = &(i18->buckets_[h18 % i18->size_]);
          COUNT_mFOLLOWER4_entry* e22;
          do if ((e22=n18->obj) && h18 == n18->hash && COUNT_mFOLLOWER4_mapkey0_idxfn::equals(se31, *e22)) {
            long count_mfollowerfollower_user_id = e22->A_FOLLOWER_ID;
            long v26 = e22->__av;
            COUNT_mFOLLOWER2.addOrDelOnZero(se30.modify(count_mfollowerfollower_user_id,tweet_tweet_id),(v26 * -1L));
          } while ((n18=n18->nxt));
        }
  ...
  class QFanout : public Program
  {
    public:
      QFanout(int argc = 0, char* argv[] = 0) : Program(argc,argv) {
      }
  };
