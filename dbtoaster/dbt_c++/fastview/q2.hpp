      ...
      {  //++tN;
        { //slice
          ...
          do if ((e3=n3->obj) && h3 == n3->hash && COUNT_mTWEET1_mapkey0_idxfn::equals(se8, *e3)) {
            ...
            long v3 = e3->__av;
            (/*if */(500000L > tweet_user_id) ? COUNT.addOrDelOnZero(se7.modify(tweet_user_id,a_follower_id,tweet_user_id,tweet_tweet_id,tweet_tweet_date),v3) : voidFunc());
          } while ((n3=n3->nxt));
        }
      ...
      {  //++tN;
        { //slice
          ...
          do if ((e4=n4->obj) && h4 == n4->hash && COUNT_mTWEET1_mapkey0_idxfn::equals(se11, *e4)) {
            ...
            long v4 = e4->__av;
            (/*if */(500000L > tweet_user_id) ? COUNT.addOrDelOnZero(se10.modify(tweet_user_id,a_follower_id,tweet_user_id,tweet_tweet_id,tweet_tweet_date),(v4 * -1L)) : voidFunc());
          } while ((n4=n4->nxt));
        }
