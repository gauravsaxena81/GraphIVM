...
namespace dbtoaster {
  ...
  struct __SQL_COUNT_AGGREGATE_1_entry {
    long U_USER_ID; long B_TWEET_ID; long __av;  __SQL_COUNT_AGGREGATE_1_entry* nxt; __SQL_COUNT_AGGREGATE_1_entry* prv;
    explicit __SQL_COUNT_AGGREGATE_1_entry() : nxt(nullptr), prv(nullptr) { /*U_USER_ID = 0L; B_TWEET_ID = 0L; __av = 0L; */ }
    explicit __SQL_COUNT_AGGREGATE_1_entry(const long c0, const long c1, const long c2) { U_USER_ID = c0; B_TWEET_ID = c1; __av = c2; }
    __SQL_COUNT_AGGREGATE_1_entry(const __SQL_COUNT_AGGREGATE_1_entry& other) : U_USER_ID( other.U_USER_ID ), B_TWEET_ID( other.B_TWEET_ID ), __av( other.__av ), nxt( nullptr ), prv( nullptr ) {}
    FORCE_INLINE __SQL_COUNT_AGGREGATE_1_entry& modify(const long c0, const long c1) { U_USER_ID = c0; B_TWEET_ID = c1;  return *this; }
  ...
  struct __SQL_COUNT_AGGREGATE_1_mapkey01_idxfn {
    ...
    FORCE_INLINE static bool equals(const __SQL_COUNT_AGGREGATE_1_entry& x, const __SQL_COUNT_AGGREGATE_1_entry& y) {
      return x.U_USER_ID == y.U_USER_ID && x.B_TWEET_ID == y.B_TWEET_ID;
    }
  };
  ...
  struct __SQL_COUNT_AGGREGATE_1_mUSERS1_entry {
    long __SQL_COUNT_AGGREGATE_1_mUSERSUSERS_USER_ID; long B_TWEET_ID; long __av;  __SQL_COUNT_AGGREGATE_1_mUSERS1_entry* nxt; __SQL_COUNT_AGGREGATE_1_mUSERS1_entry* prv;
    explicit __SQL_COUNT_AGGREGATE_1_mUSERS1_entry() : nxt(nullptr), prv(nullptr) { /*__SQL_COUNT_AGGREGATE_1_mUSERSUSERS_USER_ID = 0L; B_TWEET_ID = 0L; __av = 0L; */ }
    explicit __SQL_COUNT_AGGREGATE_1_mUSERS1_entry(const long c0, const long c1, const long c2) { __SQL_COUNT_AGGREGATE_1_mUSERSUSERS_USER_ID = c0; B_TWEET_ID = c1; __av = c2; }
    __SQL_COUNT_AGGREGATE_1_mUSERS1_entry(const __SQL_COUNT_AGGREGATE_1_mUSERS1_entry& other) : __SQL_COUNT_AGGREGATE_1_mUSERSUSERS_USER_ID( other.__SQL_COUNT_AGGREGATE_1_mUSERSUSERS_USER_ID ), B_TWEET_ID( other.B_TWEET_ID ), __av( other.__av ), nxt( nullptr ), prv( nullptr ) {}
    FORCE_INLINE __SQL_COUNT_AGGREGATE_1_mUSERS1_entry& modify(const long c0, const long c1) { __SQL_COUNT_AGGREGATE_1_mUSERSUSERS_USER_ID = c0; B_TWEET_ID = c1;  return *this; }
    FORCE_INLINE __SQL_COUNT_AGGREGATE_1_mUSERS1_entry& modify0(const long c0) { __SQL_COUNT_AGGREGATE_1_mUSERSUSERS_USER_ID = c0;  return *this; }
    template<class Archive>
    void serialize(Archive& ar, const unsigned int version) const 
    {
      ar << ELEM_SEPARATOR;
  ...
  struct __SQL_COUNT_AGGREGATE_1_mUSERS1_mapkey01_idxfn {
    ...
    FORCE_INLINE static bool equals(const __SQL_COUNT_AGGREGATE_1_mUSERS1_entry& x, const __SQL_COUNT_AGGREGATE_1_mUSERS1_entry& y) {
      return x.__SQL_COUNT_AGGREGATE_1_mUSERSUSERS_USER_ID == y.__SQL_COUNT_AGGREGATE_1_mUSERSUSERS_USER_ID && x.B_TWEET_ID == y.B_TWEET_ID;
    }
  };
  ...
  typedef MultiHashMap<__SQL_COUNT_AGGREGATE_1_mUSERS1_entry,long,
    HashIndex<__SQL_COUNT_AGGREGATE_1_mUSERS1_entry,long,__SQL_COUNT_AGGREGATE_1_mUSERS1_mapkey01_idxfn,true>,
    HashIndex<__SQL_COUNT_AGGREGATE_1_mUSERS1_entry,long,__SQL_COUNT_AGGREGATE_1_mUSERS1_mapkey0_idxfn,false>
  > __SQL_COUNT_AGGREGATE_1_mUSERS1_map;
  typedef HashIndex<__SQL_COUNT_AGGREGATE_1_mUSERS1_entry,long,__SQL_COUNT_AGGREGATE_1_mUSERS1_mapkey01_idxfn,true> HashIndex___SQL_COUNT_AGGREGATE_1_mUSERS1_map_01;
  typedef HashIndex<__SQL_COUNT_AGGREGATE_1_mUSERS1_entry,long,__SQL_COUNT_AGGREGATE_1_mUSERS1_mapkey0_idxfn,false> HashIndex___SQL_COUNT_AGGREGATE_1_mUSERS1_map_0;
  ...
  struct data_t : tlq_t{
    ...
    void on_insert_RETWEET(const long retweet_user_id, const long retweet_tweet_id, const STRING_TYPE& retweet_tweet_date, const long retweet_retweet_tweet_id) {
      ...
      {  //++tN;
		...
		api.useDiff(u_user_id, v1);
            //__SQL_COUNT_AGGREGATE_1.addOrDelOnZero(se1.modify(u_user_id,retweet_retweet_tweet_id),v1);
          } while ((n1=n1->nxt));
        }
        ...
        { //slice
          ...
          do if ((e2=n2->obj) && h2 == n2->hash && __SQL_COUNT_AGGREGATE_1_mRETWEET1_mUSERS1_mapkey1_idxfn::equals(se5, *e2)) {
            ...
            long v2 = e2->__av;
            __SQL_COUNT_AGGREGATE_1_mUSERS1.addOrDelOnZero(se4.modify(__sql_count_aggregate_1_musersusers_user_id,retweet_retweet_tweet_id),v2);
          } while ((n2=n2->nxt));
        }
      }
      ...
      {  //++tN;
        { //slice
          ...
          do if ((e3=n3->obj) && h3 == n3->hash && __SQL_COUNT_AGGREGATE_1_mRETWEET1_mapkey0_idxfn::equals(se7, *e3)) {
            ...
            long v3 = e3->__av;
		api.useDiff(u_user_id,v3);
            //__SQL_COUNT_AGGREGATE_1.addOrDelOnZero(se6.modify(u_user_id,retweet_retweet_tweet_id),(v3 * -1L));
          } while ((n3=n3->nxt));
        }
        ...
        { //slice
          ...
          do if ((e4=n4->obj) && h4 == n4->hash && __SQL_COUNT_AGGREGATE_1_mRETWEET1_mUSERS1_mapkey1_idxfn::equals(se10, *e4)) {
            ...
            long v4 = e4->__av;
            __SQL_COUNT_AGGREGATE_1_mUSERS1.addOrDelOnZero(se9.modify(__sql_count_aggregate_1_musersusers_user_id,retweet_retweet_tweet_id),(v4 * -1L));
          } while ((n4=n4->nxt));
        }
      }
    ...
    void on_insert_TWEET(const long tweet_user_id, const long tweet_tweet_id, const STRING_TYPE& tweet_tweet_date) {
      ...
      {  //++tN;
        __SQL_COUNT_AGGREGATE_1.addOrDelOnZero(se11.modify(tweet_user_id,tweet_tweet_id),(__SQL_COUNT_AGGREGATE_1_mTWEET1.getValueOrDefault(se12.modify(tweet_user_id)) * __SQL_COUNT_AGGREGATE_1_mTWEET2.getValueOrDefault(se13.modify(tweet_tweet_id))));
        ...
        __SQL_COUNT_AGGREGATE_1_mUSERS1.addOrDelOnZero(se17.modify(tweet_user_id,tweet_tweet_id),__SQL_COUNT_AGGREGATE_1_mTWEET2.getValueOrDefault(se18.modify(tweet_tweet_id)));
      }
    ...
    void on_delete_TWEET(const long tweet_user_id, const long tweet_tweet_id, const STRING_TYPE& tweet_tweet_date) {
      ...
      {  //++tN;
        __SQL_COUNT_AGGREGATE_1.addOrDelOnZero(se19.modify(tweet_user_id,tweet_tweet_id),(__SQL_COUNT_AGGREGATE_1_mTWEET1.getValueOrDefault(se20.modify(tweet_user_id)) * (__SQL_COUNT_AGGREGATE_1_mTWEET2.getValueOrDefault(se21.modify(tweet_tweet_id)) * -1L)));
        ...
        __SQL_COUNT_AGGREGATE_1_mUSERS1.addOrDelOnZero(se25.modify(tweet_user_id,tweet_tweet_id),(__SQL_COUNT_AGGREGATE_1_mTWEET2.getValueOrDefault(se26.modify(tweet_tweet_id)) * -1L));
      }
    ...
    void on_insert_USERS(const long users_user_id) {
      ...
      {  //++tN;
        { //slice
          const HASH_RES_t h5 = __SQL_COUNT_AGGREGATE_1_mUSERS1_mapkey0_idxfn::hash(se28.modify0(users_user_id));
          const HashIndex___SQL_COUNT_AGGREGATE_1_mUSERS1_map_0* i5 = static_cast<HashIndex___SQL_COUNT_AGGREGATE_1_mUSERS1_map_0*>(__SQL_COUNT_AGGREGATE_1_mUSERS1.index[1]);
          HashIndex___SQL_COUNT_AGGREGATE_1_mUSERS1_map_0::IdxNode* n5 = &(i5->buckets_[h5 % i5->size_]);
          __SQL_COUNT_AGGREGATE_1_mUSERS1_entry* e5;
          do if ((e5=n5->obj) && h5 == n5->hash && __SQL_COUNT_AGGREGATE_1_mUSERS1_mapkey0_idxfn::equals(se28, *e5)) {
            long b_tweet_id = e5->B_TWEET_ID;
            long v5 = e5->__av;
            __SQL_COUNT_AGGREGATE_1.addOrDelOnZero(se27.modify(users_user_id,b_tweet_id),v5);
          } while ((n5=n5->nxt));
        }
        { //slice
          const HASH_RES_t h6 = __SQL_COUNT_AGGREGATE_1_mRETWEET1_mUSERS1_mapkey0_idxfn::hash(se30.modify0(users_user_id));
          ...
          do if ((e6=n6->obj) && h6 == n6->hash && __SQL_COUNT_AGGREGATE_1_mRETWEET1_mUSERS1_mapkey0_idxfn::equals(se30, *e6)) {
            ...
            long v6 = e6->__av;
            __SQL_COUNT_AGGREGATE_1_mRETWEET1.addOrDelOnZero(se29.modify(__sql_count_aggregate_1_mretweetretweet_retweet_tweet_id,users_user_id),v6);
          } while ((n6=n6->nxt));
        }
    ...
    void on_delete_USERS(const long users_user_id) {
      ...
      {  //++tN;
        { //slice
          const HASH_RES_t h7 = __SQL_COUNT_AGGREGATE_1_mUSERS1_mapkey0_idxfn::hash(se33.modify0(users_user_id));
          const HashIndex___SQL_COUNT_AGGREGATE_1_mUSERS1_map_0* i7 = static_cast<HashIndex___SQL_COUNT_AGGREGATE_1_mUSERS1_map_0*>(__SQL_COUNT_AGGREGATE_1_mUSERS1.index[1]);
          HashIndex___SQL_COUNT_AGGREGATE_1_mUSERS1_map_0::IdxNode* n7 = &(i7->buckets_[h7 % i7->size_]);
          __SQL_COUNT_AGGREGATE_1_mUSERS1_entry* e7;
          do if ((e7=n7->obj) && h7 == n7->hash && __SQL_COUNT_AGGREGATE_1_mUSERS1_mapkey0_idxfn::equals(se33, *e7)) {
            long b_tweet_id = e7->B_TWEET_ID;
            long v7 = e7->__av;
            __SQL_COUNT_AGGREGATE_1.addOrDelOnZero(se32.modify(users_user_id,b_tweet_id),(v7 * -1L));
          } while ((n7=n7->nxt));
        }
        { //slice
          const HASH_RES_t h8 = __SQL_COUNT_AGGREGATE_1_mRETWEET1_mUSERS1_mapkey0_idxfn::hash(se35.modify0(users_user_id));
          const HashIndex___SQL_COUNT_AGGREGATE_1_mRETWEET1_mUSERS1_map_0* i8 = static_cast<HashIndex___SQL_COUNT_AGGREGATE_1_mRETWEET1_mUSERS1_map_0*>(__SQL_COUNT_AGGREGATE_1_mRETWEET1_mUSERS1.index[2]);
          HashIndex___SQL_COUNT_AGGREGATE_1_mRETWEET1_mUSERS1_map_0::IdxNode* n8 = &(i8->buckets_[h8 % i8->size_]);
          __SQL_COUNT_AGGREGATE_1_mRETWEET1_mUSERS1_entry* e8;
          do if ((e8=n8->obj) && h8 == n8->hash && __SQL_COUNT_AGGREGATE_1_mRETWEET1_mUSERS1_mapkey0_idxfn::equals(se35, *e8)) {
            long __sql_count_aggregate_1_mretweetretweet_retweet_tweet_id = e8->__SQL_COUNT_AGGREGATE_1_mRETWEETRETWEET_RETWEET_TWEET_ID;
            long v8 = e8->__av;
            __SQL_COUNT_AGGREGATE_1_mRETWEET1.addOrDelOnZero(se34.modify(__sql_count_aggregate_1_mretweetretweet_retweet_tweet_id,users_user_id),(v8 * -1L));
          } while ((n8=n8->nxt));
        }
