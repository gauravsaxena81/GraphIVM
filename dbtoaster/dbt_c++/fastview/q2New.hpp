...
namespace dbtoaster {
  ...
  struct COUNT_entry {
    long A_USER_ID; long A_FOLLOWER_ID; long B_USER_ID; long B_TWEET_ID; STRING_TYPE B_TWEET_DATE; long __av;  COUNT_entry* nxt; COUNT_entry* prv;
    explicit COUNT_entry() : nxt(nullptr), prv(nullptr) { /*A_USER_ID = 0L; A_FOLLOWER_ID = 0L; B_USER_ID = 0L; B_TWEET_ID = 0L; B_TWEET_DATE = ""; __av = 0L; */ }
    explicit COUNT_entry(const long c0, const long c1, const long c2, const long c3, const STRING_TYPE& c4, const long c5) { A_USER_ID = c0; A_FOLLOWER_ID = c1; B_USER_ID = c2; B_TWEET_ID = c3; B_TWEET_DATE = c4; __av = c5; }
    COUNT_entry(const COUNT_entry& other) : A_USER_ID( other.A_USER_ID ), A_FOLLOWER_ID( other.A_FOLLOWER_ID ), B_USER_ID( other.B_USER_ID ), B_TWEET_ID( other.B_TWEET_ID ), B_TWEET_DATE( other.B_TWEET_DATE ), __av( other.__av ), nxt( nullptr ), prv( nullptr ) {}
    FORCE_INLINE COUNT_entry& modify(const long c0, const long c1, const long c2, const long c3, const STRING_TYPE& c4) { A_USER_ID = c0; A_FOLLOWER_ID = c1; B_USER_ID = c2; B_TWEET_ID = c3; B_TWEET_DATE = c4;  return *this; }
  ...
  struct COUNT_mapkey01234_idxfn {
    ...
    FORCE_INLINE static bool equals(const COUNT_entry& x, const COUNT_entry& y) {
      return x.A_USER_ID == y.A_USER_ID && x.A_FOLLOWER_ID == y.A_FOLLOWER_ID && x.B_USER_ID == y.B_USER_ID && x.B_TWEET_ID == y.B_TWEET_ID && x.B_TWEET_DATE == y.B_TWEET_DATE;
    }
  };
  ...
  struct COUNT_mTWEET1_entry {
    long A_USER_ID; long A_FOLLOWER_ID; long COUNT_mTWEETTWEET_USER_ID; long __av;  COUNT_mTWEET1_entry* nxt; COUNT_mTWEET1_entry* prv;
    explicit COUNT_mTWEET1_entry() : nxt(nullptr), prv(nullptr) { /*A_USER_ID = 0L; A_FOLLOWER_ID = 0L; COUNT_mTWEETTWEET_USER_ID = 0L; __av = 0L; */ }
    explicit COUNT_mTWEET1_entry(const long c0, const long c1, const long c2, const long c3) { A_USER_ID = c0; A_FOLLOWER_ID = c1; COUNT_mTWEETTWEET_USER_ID = c2; __av = c3; }
    COUNT_mTWEET1_entry(const COUNT_mTWEET1_entry& other) : A_USER_ID( other.A_USER_ID ), A_FOLLOWER_ID( other.A_FOLLOWER_ID ), COUNT_mTWEETTWEET_USER_ID( other.COUNT_mTWEETTWEET_USER_ID ), __av( other.__av ), nxt( nullptr ), prv( nullptr ) {}
    FORCE_INLINE COUNT_mTWEET1_entry& modify(const long c0, const long c1, const long c2) { A_USER_ID = c0; A_FOLLOWER_ID = c1; COUNT_mTWEETTWEET_USER_ID = c2;  return *this; }
    FORCE_INLINE COUNT_mTWEET1_entry& modify2(const long c2) { COUNT_mTWEETTWEET_USER_ID = c2;  return *this; }
    template<class Archive>
    void serialize(Archive& ar, const unsigned int version) const 
    {
      ar << ELEM_SEPARATOR;
  ...
  struct COUNT_mTWEET1_mapkey012_idxfn {
    ...
    FORCE_INLINE static bool equals(const COUNT_mTWEET1_entry& x, const COUNT_mTWEET1_entry& y) {
      return x.A_USER_ID == y.A_USER_ID && x.A_FOLLOWER_ID == y.A_FOLLOWER_ID && x.COUNT_mTWEETTWEET_USER_ID == y.COUNT_mTWEETTWEET_USER_ID;
    }
  };
  
  struct COUNT_mTWEET1_mapkey2_idxfn {
    FORCE_INLINE static size_t hash(const COUNT_mTWEET1_entry& e) {
      size_t h = 0;
      hash_combine(h, e.COUNT_mTWEETTWEET_USER_ID);
      return h;
  ...
  typedef MultiHashMap<COUNT_mTWEET1_entry,long,
    HashIndex<COUNT_mTWEET1_entry,long,COUNT_mTWEET1_mapkey012_idxfn,true>,
    HashIndex<COUNT_mTWEET1_entry,long,COUNT_mTWEET1_mapkey2_idxfn,false>
  > COUNT_mTWEET1_map;
  typedef HashIndex<COUNT_mTWEET1_entry,long,COUNT_mTWEET1_mapkey012_idxfn,true> HashIndex_COUNT_mTWEET1_map_012;
  typedef HashIndex<COUNT_mTWEET1_entry,long,COUNT_mTWEET1_mapkey2_idxfn,false> HashIndex_COUNT_mTWEET1_map_2;
  
  struct COUNT_mFOLLOWER1_entry {
    long B_USER_ID; long B_TWEET_ID; STRING_TYPE B_TWEET_DATE; long __av;  COUNT_mFOLLOWER1_entry* nxt; COUNT_mFOLLOWER1_entry* prv;
    explicit COUNT_mFOLLOWER1_entry() : nxt(nullptr), prv(nullptr) { /*B_USER_ID = 0L; B_TWEET_ID = 0L; B_TWEET_DATE = ""; __av = 0L; */ }
    explicit COUNT_mFOLLOWER1_entry(const long c0, const long c1, const STRING_TYPE& c2, const long c3) { B_USER_ID = c0; B_TWEET_ID = c1; B_TWEET_DATE = c2; __av = c3; }
    COUNT_mFOLLOWER1_entry(const COUNT_mFOLLOWER1_entry& other) : B_USER_ID( other.B_USER_ID ), B_TWEET_ID( other.B_TWEET_ID ), B_TWEET_DATE( other.B_TWEET_DATE ), __av( other.__av ), nxt( nullptr ), prv( nullptr ) {}
    FORCE_INLINE COUNT_mFOLLOWER1_entry& modify(const long c0, const long c1, const STRING_TYPE& c2) { B_USER_ID = c0; B_TWEET_ID = c1; B_TWEET_DATE = c2;  return *this; }
    FORCE_INLINE COUNT_mFOLLOWER1_entry& modify0(const long c0) { B_USER_ID = c0;  return *this; }
    template<class Archive>
    void serialize(Archive& ar, const unsigned int version) const 
    {
      ar << ELEM_SEPARATOR;
  ...
  struct COUNT_mFOLLOWER1_mapkey012_idxfn {
    ...
    FORCE_INLINE static bool equals(const COUNT_mFOLLOWER1_entry& x, const COUNT_mFOLLOWER1_entry& y) {
      return x.B_USER_ID == y.B_USER_ID && x.B_TWEET_ID == y.B_TWEET_ID && x.B_TWEET_DATE == y.B_TWEET_DATE;
    }
  };
  ...
  struct COUNT_mFOLLOWER1_mapkey0_idxfn {
    ...
    FORCE_INLINE static bool equals(const COUNT_mFOLLOWER1_entry& x, const COUNT_mFOLLOWER1_entry& y) {
      return x.B_USER_ID == y.B_USER_ID;
    }
  };
  ...
  struct data_t : tlq_t{
      ...
      {  //++tN;
        { //slice
          ...
          do if ((e1=n1->obj) && h1 == n1->hash && COUNT_mFOLLOWER1_mapkey0_idxfn::equals(se2, *e1)) {
            ...
            long v1 = e1->__av;
            (/*if */(500000L > follower_user_id) ? COUNT.addOrDelOnZero(se1.modify(follower_user_id,follower_follower_id,follower_user_id,b_tweet_id,b_tweet_date),v1) : voidFunc());
          } while ((n1=n1->nxt));
        }
        (/*if */(500000L > follower_user_id) ? COUNT_mTWEET1.addOrDelOnZero(se3.modify(follower_user_id,follower_follower_id,follower_user_id),1L) : voidFunc());
      }
      ...
      {  //++tN;
        { //slice
          ...
          do if ((e2=n2->obj) && h2 == n2->hash && COUNT_mFOLLOWER1_mapkey0_idxfn::equals(se5, *e2)) {
            ...
            long v2 = e2->__av;
            (/*if */(500000L > follower_user_id) ? COUNT.addOrDelOnZero(se4.modify(follower_user_id,follower_follower_id,follower_user_id,b_tweet_id,b_tweet_date),(v2 * -1L)) : voidFunc());
          } while ((n2=n2->nxt));
        }
        (/*if */(500000L > follower_user_id) ? COUNT_mTWEET1.addOrDelOnZero(se6.modify(follower_user_id,follower_follower_id,follower_user_id),-1L) : voidFunc());
      }
    ...
    void on_insert_TWEET(const long tweet_user_id, const long tweet_tweet_id, const STRING_TYPE& tweet_tweet_date) {
      ...
      {  //++tN;
        { //slice
          const HASH_RES_t h3 = COUNT_mTWEET1_mapkey2_idxfn::hash(se8.modify2(tweet_user_id));
          const HashIndex_COUNT_mTWEET1_map_2* i3 = static_cast<HashIndex_COUNT_mTWEET1_map_2*>(COUNT_mTWEET1.index[1]);
          HashIndex_COUNT_mTWEET1_map_2::IdxNode* n3 = &(i3->buckets_[h3 % i3->size_]);
          COUNT_mTWEET1_entry* e3;
          do if ((e3=n3->obj) && h3 == n3->hash && COUNT_mTWEET1_mapkey2_idxfn::equals(se8, *e3)) {
            long a_user_id = e3->A_USER_ID;
            long a_follower_id = e3->A_FOLLOWER_ID;
            long v3 = e3->__av;
            (/*if */(500000L > tweet_user_id) ? COUNT.addOrDelOnZero(se7.modify(a_user_id,a_follower_id,tweet_user_id,tweet_tweet_id,tweet_tweet_date),v3) : voidFunc());
          } while ((n3=n3->nxt));
        }
        (/*if */(500000L > tweet_user_id) ? COUNT_mFOLLOWER1.addOrDelOnZero(se9.modify(tweet_user_id,tweet_tweet_id,tweet_tweet_date),1L) : voidFunc());
      }
    ...
    void on_delete_TWEET(const long tweet_user_id, const long tweet_tweet_id, const STRING_TYPE& tweet_tweet_date) {
      ...
      {  //++tN;
        { //slice
          const HASH_RES_t h4 = COUNT_mTWEET1_mapkey2_idxfn::hash(se11.modify2(tweet_user_id));
          const HashIndex_COUNT_mTWEET1_map_2* i4 = static_cast<HashIndex_COUNT_mTWEET1_map_2*>(COUNT_mTWEET1.index[1]);
          HashIndex_COUNT_mTWEET1_map_2::IdxNode* n4 = &(i4->buckets_[h4 % i4->size_]);
          COUNT_mTWEET1_entry* e4;
          do if ((e4=n4->obj) && h4 == n4->hash && COUNT_mTWEET1_mapkey2_idxfn::equals(se11, *e4)) {
            long a_user_id = e4->A_USER_ID;
            long a_follower_id = e4->A_FOLLOWER_ID;
            long v4 = e4->__av;
            (/*if */(500000L > tweet_user_id) ? COUNT.addOrDelOnZero(se10.modify(a_user_id,a_follower_id,tweet_user_id,tweet_tweet_id,tweet_tweet_date),(v4 * -1L)) : voidFunc());
          } while ((n4=n4->nxt));
        }
        (/*if */(500000L > tweet_user_id) ? COUNT_mFOLLOWER1.addOrDelOnZero(se12.modify(tweet_user_id,tweet_tweet_id,tweet_tweet_date),-1L) : voidFunc());
      }
  ...
  class Q2New : public Program
  {
    public:
      Q2New(int argc = 0, char* argv[] = 0) : Program(argc,argv) {
      }
  };
