...
namespace dbtoaster {
  ...
  struct data_t : tlq_t{
    ...
    void on_insert_TWEET(const long tweet_user_id, const long tweet_tweet_id, STRING_TYPE& tweet_tweet_date) {
      ...
      {  //++tN;
        { //slice
          ...
          do if ((e3=n3->obj) && h3 == n3->hash && COUNT_mTWEET1_mapkey0_idxfn::equals(se8, *e3)) {
            ...
            long v3 = e3->__av;
	//	api.useDiff(tweet_user_id,a_follower_id,tweet_user_id,tweet_tweet_id,tweet_tweet_date);
  ...
  class Q2p : public Program
  {
    public:
      Q2p(int argc = 0, char* argv[] = 0) : Program(argc,argv) {
      }
  };
