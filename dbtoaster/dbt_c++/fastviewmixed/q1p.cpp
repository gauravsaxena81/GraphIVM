			...
			try {//PT
				pqxx::connection C("dbname=bsmagen1m user=gaurav password=gaurav \
				 ...
				 return;
			      ...
			      std::string sql = "select user_id, tweet_id, tweet_date, -1 as retweet_tweet_id from tweet T union select user_id, tweet_id, tweet_date, retweet_tweet_id from retweet order by 2 desc limit 50000";
