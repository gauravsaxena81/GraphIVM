...
namespace dbtoaster {
  ...
  struct COUNT_mUSERS1_entry {
    long B_USER_ID; long B_TWEET_ID; STRING_TYPE B_TWEET_DATE; long __av;  COUNT_mUSERS1_entry* nxt; COUNT_mUSERS1_entry* prv;
    explicit COUNT_mUSERS1_entry() : nxt(nullptr), prv(nullptr) { /*B_USER_ID = 0L; B_TWEET_ID = 0L; B_TWEET_DATE = ""; __av = 0L; */ }
    explicit COUNT_mUSERS1_entry(const long c0, const long c1, const STRING_TYPE& c2, const long c3) { B_USER_ID = c0; B_TWEET_ID = c1; B_TWEET_DATE = c2; __av = c3; }
    COUNT_mUSERS1_entry(const COUNT_mUSERS1_entry& other) : B_USER_ID( other.B_USER_ID ), B_TWEET_ID( other.B_TWEET_ID ), B_TWEET_DATE( other.B_TWEET_DATE ), __av( other.__av ), nxt( nullptr ), prv( nullptr ) {}
    FORCE_INLINE COUNT_mUSERS1_entry& modify(const long c0, const long c1, const STRING_TYPE& c2) { B_USER_ID = c0; B_TWEET_ID = c1; B_TWEET_DATE = c2;  return *this; }
    FORCE_INLINE COUNT_mUSERS1_entry& modify0(const long c0) { B_USER_ID = c0;  return *this; }
    template<class Archive>
    void serialize(Archive& ar, const unsigned int version) const 
    {
      ar << ELEM_SEPARATOR;
  ...
  struct data_t : tlq_t{
    ...
    void on_insert_TWEET(const long tweet_user_id, const long tweet_tweet_id, const STRING_TYPE& tweet_tweet_date) {
      ...
      {  //++tN;
        { //slice
          const HASH_RES_t h1 = COUNT_mTWEET1_mapkey1_idxfn::hash(se2.modify1(tweet_user_id));
          const HashIndex_COUNT_mTWEET1_map_1* i1 = static_cast<HashIndex_COUNT_mTWEET1_map_1*>(COUNT_mTWEET1.index[1]);
          HashIndex_COUNT_mTWEET1_map_1::IdxNode* n1 = &(i1->buckets_[h1 % i1->size_]);
          COUNT_mTWEET1_entry* e1;
          do if ((e1=n1->obj) && h1 == n1->hash && COUNT_mTWEET1_mapkey1_idxfn::equals(se2, *e1)) {
            long a_user_id = e1->A_USER_ID;
            long v1 = e1->__av;
            COUNT.addOrDelOnZero(se1.modify(a_user_id,tweet_user_id,tweet_tweet_id,tweet_tweet_date),v1);
          } while ((n1=n1->nxt));
        }
    ...
    void on_delete_TWEET(const long tweet_user_id, const long tweet_tweet_id, const STRING_TYPE& tweet_tweet_date) {
      ...
      {  //++tN;
        { //slice
          const HASH_RES_t h2 = COUNT_mTWEET1_mapkey1_idxfn::hash(se5.modify1(tweet_user_id));
          const HashIndex_COUNT_mTWEET1_map_1* i2 = static_cast<HashIndex_COUNT_mTWEET1_map_1*>(COUNT_mTWEET1.index[1]);
          HashIndex_COUNT_mTWEET1_map_1::IdxNode* n2 = &(i2->buckets_[h2 % i2->size_]);
          COUNT_mTWEET1_entry* e2;
          do if ((e2=n2->obj) && h2 == n2->hash && COUNT_mTWEET1_mapkey1_idxfn::equals(se5, *e2)) {
            long a_user_id = e2->A_USER_ID;
            long v2 = e2->__av;
            COUNT.addOrDelOnZero(se4.modify(a_user_id,tweet_user_id,tweet_tweet_id,tweet_tweet_date),(v2 * -1L));
          } while ((n2=n2->nxt));
        }
    ...
    void on_insert_USERS(const long users_user_id) {
      ...
      {  //++tN;
        { //slice
          const HASH_RES_t h3 = COUNT_mUSERS1_mapkey0_idxfn::hash(se8.modify0(users_user_id));
          const HashIndex_COUNT_mUSERS1_map_0* i3 = static_cast<HashIndex_COUNT_mUSERS1_map_0*>(COUNT_mUSERS1.index[1]);
          HashIndex_COUNT_mUSERS1_map_0::IdxNode* n3 = &(i3->buckets_[h3 % i3->size_]);
          COUNT_mUSERS1_entry* e3;
          do if ((e3=n3->obj) && h3 == n3->hash && COUNT_mUSERS1_mapkey0_idxfn::equals(se8, *e3)) {
            long b_tweet_id = e3->B_TWEET_ID;
            STRING_TYPE b_tweet_date = e3->B_TWEET_DATE;
            long v3 = e3->__av;
            COUNT.addOrDelOnZero(se7.modify(users_user_id,users_user_id,b_tweet_id,b_tweet_date),v3);
          } while ((n3=n3->nxt));
        }
        COUNT_mTWEET1.addOrDelOnZero(se9.modify(users_user_id,users_user_id),1L);
      }
    ...
    void on_delete_USERS(const long users_user_id) {
      ...
      {  //++tN;
        { //slice
          const HASH_RES_t h4 = COUNT_mUSERS1_mapkey0_idxfn::hash(se11.modify0(users_user_id));
          const HashIndex_COUNT_mUSERS1_map_0* i4 = static_cast<HashIndex_COUNT_mUSERS1_map_0*>(COUNT_mUSERS1.index[1]);
          HashIndex_COUNT_mUSERS1_map_0::IdxNode* n4 = &(i4->buckets_[h4 % i4->size_]);
          COUNT_mUSERS1_entry* e4;
          do if ((e4=n4->obj) && h4 == n4->hash && COUNT_mUSERS1_mapkey0_idxfn::equals(se11, *e4)) {
            long b_tweet_id = e4->B_TWEET_ID;
            STRING_TYPE b_tweet_date = e4->B_TWEET_DATE;
            long v4 = e4->__av;
            COUNT.addOrDelOnZero(se10.modify(users_user_id,users_user_id,b_tweet_id,b_tweet_date),(v4 * -1L));
          } while ((n4=n4->nxt));
        }
        COUNT_mTWEET1.addOrDelOnZero(se12.modify(users_user_id,users_user_id),-1L);
      }
