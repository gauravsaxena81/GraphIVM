...
public final class IntArrayList
{
     ...
     */
    static final int[] EMPTY_ELEMENTDATA = {};
    ...
    public IntArrayList(IntArrayList c) {
        super();
        if(c.elementData == EMPTY_ELEMENTDATA)
            elementData = EMPTY_ELEMENTDATA;
        else
            elementData = Arrays.copyOf(c.elementData, c.elementData.length);
        this.size = c.size;
    }
