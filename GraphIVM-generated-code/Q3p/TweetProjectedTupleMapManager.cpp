...
#include <stdlib.h>
#include <iostream>
inline static void hashCode(int&h, int& userIdTweetUserId, int& tweetTweetIdRetweetRetweetTweetId, std::string& tweetDate ) __attribute__((always_inline));
...
__inline static void hashCode(int& h, int& userIdTweetUserId, int& tweetTweetIdRetweetRetweetTweetId, std::string& tweetDate ) {
...
TweetProjectedTupleEntry* putTweetProjectedTuple(TweetProjectedTupleMap* tweetProjectedTupleMap, int& userIdTweetUserId, int& tweetTweetIdRetweetRetweetTweetId, std::string& tweetDate ) {
	int h = 31;
	hashCode(h
	, userIdTweetUserId
