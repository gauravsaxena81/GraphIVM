...
inline static void hashCode(int& h, int& r2TweetIdR3RetweetTweetId,int& r3TweetIdR4RetweetTweetId) __attribute__((always_inline));
static void ensureSize(Retweet3JoinTupleMap* retweet3JoinTupleMap, int& r2TweetIdR3RetweetTweetId,int& r3TweetIdR4RetweetTweetId);
static void increaseArraySize(Retweet3JoinTupleMap* retweet3JoinTupleMap, int& r2TweetIdR3RetweetTweetId,int& r3TweetIdR4RetweetTweetId);
...
static void addToVertexValues(int& r3TweetIdR4RetweetTweetId , Retweet3JoinTupleEntry* p, Retweet3Retweet4VertexValueMap* retweet3Retweet4VertexValueMap);



__inline static void ensureSize(Retweet3JoinTupleMap* retweet3JoinTupleMap, int& r2TweetIdR3RetweetTweetId,int& r3TweetIdR4RetweetTweetId) {
    if(retweet3JoinTupleMap->size >= retweet3JoinTupleMap->capacity * 0.8) {
        increaseArraySize(retweet3JoinTupleMap, r2TweetIdR3RetweetTweetId, r3TweetIdR4RetweetTweetId );
    }
}
static void increaseArraySize(Retweet3JoinTupleMap* retweet3JoinTupleMap, int& r2TweetIdR3RetweetTweetId,int& r3TweetIdR4RetweetTweetId) {
    ...
    for(int i = 0; i < retweet3JoinTupleMap->capacity; i++) {
        ...
        if(p) {
            do {
                int h = 31;
                hashCode(h, r2TweetIdR3RetweetTweetId, r3TweetIdR4RetweetTweetId );
                h = h & (newcapacity - 1);
...
Retweet3JoinTupleEntry* putRetweet3JoinTupleIfAbsent(Retweet3JoinTupleMap* retweet3JoinTupleMap, int& r2TweetIdR3RetweetTweetId,int& r3TweetIdR4RetweetTweetId, Retweet2Retweet3VertexValueMap* retweet2Retweet3VertexValueMap, Retweet3Retweet4VertexValueMap* retweet3Retweet4VertexValueMap ) {
    ...
    ensureSize(retweet3JoinTupleMap, r2TweetIdR3RetweetTweetId, r3TweetIdR4RetweetTweetId );
...
__inline static void addToVertexValues(int& r3TweetIdR4RetweetTweetId , Retweet3JoinTupleEntry* p, Retweet3Retweet4VertexValueMap* retweet3Retweet4VertexValueMap) {
...
inline static void hashCode(int&h, int& r2TweetIdR3RetweetTweetId,int& r3TweetIdR4RetweetTweetId) {
